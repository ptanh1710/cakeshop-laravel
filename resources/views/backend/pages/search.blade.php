    ...
    <div class="mt-2 border bg-light">
        ...
        <div class="row  m-2">
            <div class="col text-start fw-bold">
                <p>
                    Tổng danh sách hoá đơn bán hàng ngày <span style="color: #ff0000">{{$dateSelect}}</span> : {{$count}} / {{$countTotal}} tổng số hoá đơn
                </p>
            </div>
            ...
            <div class="col">
                <form action="{{URL::TO('/admin/show_bill_status')}}" method="get">
                    <div class="row d-flex flex-row">
                        ...
                        <div class="col-lg-5">
                            <input type="date" class="form-control" name="bill_date" id="setDateValue" value="{{$dateSelect}}" />
                        </div>
                        <div class="col-lg-3">
