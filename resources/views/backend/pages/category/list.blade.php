...
@section('title', 'Tất cả loại bánh')
    ...
    <div class="mt-2 border bg-light">
        ...
        <div class="row">
            <div class="col-lg-6  text-start">
                <p class="ms-3 fw-bold">Tổng số loại bánh hiện có: {{$count}}</p>
            </div>
            <div class="col-lg-6 text-center">
                <div class="row">
                    <div class="col-lg-6">
                        <p class="ms-3 fw-bold">Đã kích hoạt: {{$cate_acitve}}</p>
                    </div>
                    <div class="col-lg-6">
                <p class="ms-3 fw-bold">Chưa kích hoạt: {{$cate_unacitve}}</p>
                    </div>
                </div>
            </div>
        </div>
