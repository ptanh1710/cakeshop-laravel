    ...
    <div class="mt-2 border bg-light">
        ...
        <div class="row">
            <div class="col-lg-12  text-start">
                <p class="ms-3 fw-bold">Tổng số sản phẩm thuộc loại '{{$cate_name}}': {{$count}} sản phẩm</p>
            </div>
        </div>
